...
description: Write Instagram and TikTok captions, hashtag sets, alt text, on-screen text, and teleprompter scripts for a fashion and fitness creator, in her own plain casual voice, built to get found in in-app search. Use this skill whenever she is making a post, reel, story, carousel, or video and needs the words that go with it - meals, workouts, outfits, gym check-ins, what-I-eat-in-a-day, day-in-the-life, product mentions, or talking-to-camera videos. Trigger it even when she never says the word "caption": "I'm posting my dinner tomorrow", "need something to go with this gym pic", "what do I say on this reel", "write the script for my video about protein" all mean this skill. Output is finished text she pastes straight into the app with nothing left to edit.
---
